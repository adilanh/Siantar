...
<x-app-layout>
  ...
  <main class="container wrap py-4">
    ...
    <p class="page-sub">Daftar seluruh surat keluar yang Anda kirim</p>
    ...
    <section class="card-box mt-4 p-3 p-lg-4">
        ...
        <table class="table align-middle">
          <thead>
            <tr>
              ...
              <th style="min-width:160px">Penerima</th>
              <th>Perihal</th>
          ...
          <tbody>
            <tr>
              <td class="fw-bold">011/KB/2024</td>
              ...
              <td class="text-center"><a class="btn btn-detail" href="{{ route('detail-surat-keluar') }}">Lihat Detail</a></td>
            </tr>
            <tr>
              <td class="fw-bold">012/KB/2024</td>
              <td class="muted">14 Jan 2024</td>
              <td class="muted">Kepolisian Resort</td>
              <td class="muted">Laporan Kegiatan Keamanan</td>
              <td class="text-center"><span class="pill orange">Diproses</span></td>
              <td class="text-center"><a class="btn btn-detail" href="{{ route('detail-surat-keluar') }}">Lihat Detail</a></td>
            </tr>
            <tr>
              <td class="fw-bold">013/KB/2024</td>
              <td class="muted">13 Jan 2024</td>
              <td class="muted">Bappeda</td>
              <td class="muted">Koordinasi Program Pembangunan</td>
              <td class="text-center"><span class="pill green">Terkirim</span></td>
              <td class="text-center"><a class="btn btn-detail" href="{{ route('detail-surat-keluar') }}">Lihat Detail</a></td>
            </tr>
            <tr>
              <td class="fw-bold">014/KB/2024</td>
              <td class="muted">12 Jan 2024</td>
              <td class="muted">Sekretariat Daerah</td>
              <td class="muted">Surat Tugas Monitoring</td>
              <td class="text-center"><span class="pill green">Terkirim</span></td>
              <td class="text-center"><a class="btn btn-detail" href="{{ route('detail-surat-keluar') }}">Lihat Detail</a></td>
            </tr>
            <tr>
              <td class="fw-bold">015/KB/2024</td>
              <td class="muted">11 Jan 2024</td>
              <td class="muted">Dinas Sosial</td>
              <td class="muted">Pemberitahuan Bantuan Sosial</td>
              <td class="text-center"><span class="pill green">Terkirim</span></td>
              <td class="text-center"><a class="btn btn-detail" href="{{ route('detail-surat-keluar') }}">Lihat Detail</a></td>
            </tr>
          </tbody>
      ...
      <div class="d-flex align-items-center justify-content-between mt-3">
        <div class="text-muted" style="font-size:13px;">Menampilkan 1-5 dari 23 surat keluar</div>
        <div class="pager">
