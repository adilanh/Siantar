...
<style>
  ...
  <style>
    .mini-sub{color:#9aa3b2; font-size:12px; margin-top:4px}
  </style>
@endpush
<x-app-layout>
<div class="bg-[#f5f7fb]">
<main class="container wrap py-4">
    ...
    <p class="page-sub">Gunakan formulir berikut untuk mencatat surat masuk ke dalam sistem.</p>

    <section class="card-box p-3 p-lg-4">
      <div class="section-title mb-3">
        <span class="sec-ico"><i class="bi bi-inbox-fill"></i></span>
        Informasi Surat
      </div>

      <div class="row g-3">
        <div class="col-lg-6">
          <div class="label">Nomor Surat <span class="req">*</span></div>
          <input class="form-control" placeholder="Masukkan nomor surat" />
        </div>
        <div class="col-lg-6">
          <div class="label">Pengirim <span class="req">*</span></div>
        ...
        <div class="col-lg-6">
          <div class="label">Tanggal Diterima <span class="req">*</span></div>
          <div class="input-icon">
            <input class="form-control" placeholder="mm/dd/yyyy" />
            <i class="bi bi-calendar3"></i>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <input class="form-control" value="Surat Masuk" />
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control textarea-lg" placeholder="Ringkasan singkat isi surat..."></textarea>
          <div class="help"><i class="bi bi-info-circle"></i> Ringkasan isi surat digunakan sebagai gambaran umum isi dokumen.</div>
        </div>

        <div class="col-12 mt-2">
          <div class="label" style="font-size:13px; font-weight:900; color:#374151;">Data Tambahan</div>
          <div class="mini-sub">Kolom opsional digunakan jika data tersedia, dapat dikosongkan bila tidak ada.</div>
        </div>

        <div class="col-lg-6">
          <div class="label">Nomor Berkas <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" placeholder="Masukkan nomor berkas" />
        </div>
        <div class="col-lg-6">
          <div class="label">Dari Surat Masuk - Tanggal <span class="text-muted">(Opsional)</span></div>
          <div class="input-icon">
            <input class="form-control" placeholder="mm/dd/yyyy" />
            <i class="bi bi-calendar3"></i>
          </div>
        ...
        <div class="col-lg-6">
          <div class="label">Dari Surat Masuk - Nomor <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" placeholder="Masukkan nomor surat referensi" />
        </div>
        <div class="col-lg-6">
          <div class="label">Nomor Petunjuk <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" placeholder="Masukkan nomor petunjuk" />
        </div>

        <div class="col-lg-6">
          <div class="label">Nomor Paket <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" placeholder="Masukkan nomor paket" />
        </div>
      </div>
    </section>
    ...
    <section class="card-box p-3 p-lg-4 mt-3">
      ...
      <div class="note-blue">
        ...
        <div><strong>Tips:</strong> Gunakan fitur kamera untuk memotret surat fisik jika belum tersedia dalam bentuk file digital.</div>
      </div>
    </section>
