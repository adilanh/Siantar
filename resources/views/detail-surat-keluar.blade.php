...
<x-app-layout>
  <div class="bg-[#f5f7fb]">
    ...
    <h1 class="page-title" style="margin-top:8px;">Undangan Rapat Koordinasi</h1>
    <p class="page-sub">Informasi lengkap mengenai surat keluar (Undangan Rapat Koordinasi)</p>

    <section class="card-box mt-3">
      <div class="detail-header d-flex align-items-start justify-content-between">
        <div class="d-flex flex-column gap-2">
          <div><span class="pill pill-yellow">Menunggu</span></div>
        </div>
        ...
        <div class="row g-4 detail-grid">
          <div class="col-lg-6">
            <div class="kv">
              ...
              <div class="v bold">005/KB/XII/2024</div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="kv">
              <div class="k">Tujuan</div>
              <div class="v bold">Dinas Pendidikan</div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="kv">
              ...
              <div class="v bold">20 Desember 2024</div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="kv">
              <div class="k">Perihal</div>
              <div class="v bold">Undangan Rapat Koordinasi</div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="kv">
              ...
              <div class="v">Surat Keluar</div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="kv">
              <div class="k">Kategori</div>
              <div class="v">Undangan</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="card-box mt-3">
      ...
      <div class="section-body">
        <div class="paragraph">
          Sehubungan dengan akan dilaksanakannya kegiatan koordinasi antarinstansi, bersama surat ini kami mengundang Dinas Pendidikan untuk menghadiri Rapat Koordinasi yang akan diselenggarakan oleh Badan Kesatuan Bangsa dan Politik Kota Bandar Lampung.
          <br><br>
          <strong>Detail Kegiatan:</strong><br>
          Hari/Tanggal: Jumat, 20 Desember 2024<br>
          Waktu: 09.00 WIB – Selesai<br>
          Tempat: Ruang Rapat Kesbangpol
        </div>
      </div>
    </section>
    ...
    <section class="card-box mt-3">
      ...
      <div class="section-body">
        <div class="dl-line">
          ...
          <div>
            <div class="file-name">Undangan_Rapat_Koordinasi.pdf</div>
            <div class="file-meta">PDF · 1.9 MB</div>
          </div>
